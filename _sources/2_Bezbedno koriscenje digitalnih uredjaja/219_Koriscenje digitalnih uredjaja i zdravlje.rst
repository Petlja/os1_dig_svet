...
.. mchoice:: p219a
   :multiple_answers:
   :hide_labels:
   :answer_a: Немој да користиш храну или пиће у близини дигиталног уређаја.
   :answer_b: Користи дигитални уређај само уз присуство теби блиске одрасле особе.
   :answer_c: Врати таблет на пуњење након употребе ако је батерија скоро празна.
   :answer_d: Остави таблет на безбедном месту када га не користиш.
   :answer_e: Чврсто држи таблет када га користиш.
...
.. mchoice:: p219b
   :multiple_answers:
   :hide_labels:
   :answer_a: Утиче на замућење вида.
   :answer_b: Изазива болове у врату, раменима и шакама.
   :answer_c: Утиче на расположење.
   :answer_d: Помаже да будем физички активнији.     
   :answer_e: Чврсто држи таблет када га користиш.
   :feedback_a: Одговор је тачан.
   :feedback_b: Одговор је тачан.
   :feedback_c: Одговор је тачан.
